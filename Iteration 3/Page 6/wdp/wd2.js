...
.container1 { position: relative; height: 650px; width:850px ; background-image:url('wdp/HPV Prevention.jpg');  background-repeat: no-repeat;  background-position: center; background-size: cover;}
input { display: none; }
p { margin: 0; }
